...
public class ETLtest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        flinkSqlService.createTableInMysql(province_data_shanxi, tableFieldDescs);
        ...
        flinkSqlService.createTableInMysql(province_data_guangdong, tableFieldDescs);
